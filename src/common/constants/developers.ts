...
export const DEVELOPERS = {
  DIMA: {
    ...
    goal: 'Занимался разработкой игры "Спринт", раздела "Статистика", работал над библиотекой компонентов. Взял на себя роль тимлида: занимался координацией, распределением задач, проведением общих встреч.',
    photo: photoDima,
    github: 'https://github.com/onskulit',
  },
  EGOR: {
    name: 'Егор',
    about:
    ...
    photo: photoEgor,
    github: 'https://github.com/Egor-Dubovik',
  },
  ANDREY: {
    name: 'Андрей',
    about:
    ...
    photo: photoAndrey,
    github: 'https://github.com/Trouble-Andrew',
  },
};
